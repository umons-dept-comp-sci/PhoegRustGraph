...
mod tests {
    ...
    #[test]
    fn test_isolate_incl_adj() {
        test_transfo("A_", super::isolate_incl_adj, &mut vec![]);
        test_transfo("Bw", super::isolate_incl_adj, &mut vec!["BG"]);
        test_transfo("BG", super::isolate_incl_adj, &mut vec![]);
